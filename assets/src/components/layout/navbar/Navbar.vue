<template>
    <nav class="navbar app-navbar navbar-toggleable-md">
        <div class="navbar-brand-container d-flex align-items-center justify-content-start">
            <router-link to="/"><i class="i-vuestic"></i></router-link>
        </div>
                ...
                <div class="dropdown-menu last">
                    <div class="dropdown-menu-content">
                        <div class="dropdown-item plain-link-item">
                            <router-link class="plain-link" to="/users/profile">My Profile</router-link>
                        </div>
                        <div class="dropdown-item plain-link-item">
                            <a v-on:click.prevent="logout" class="plain-link" href="#">Logout</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    methods: {
      ...
      logout() {
        this.$store.dispatch('logout')
          .then(() => this.$router.replace(ROUTE_AUTH_LOGIN));
      }
    }
  };
</script>
